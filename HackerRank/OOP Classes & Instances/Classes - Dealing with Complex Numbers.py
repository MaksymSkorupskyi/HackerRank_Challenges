...
They are used by interpreters and are generally used in the implementation of overloaded operators
...
class Complex:
    ...
    def __truediv__(self, no):
        return Complex((self.real * no.real + self.imaginary * no.imaginary) / (no.real ** 2 + no.imaginary ** 2),
                       (no.real * self.imaginary - self.real * no.imaginary) / (no.real ** 2 + no.imaginary ** 2))

    def mod(self):
        return "%.2f+0.00i" % (self.real ** 2 + self.imaginary ** 2) ** 0.5
